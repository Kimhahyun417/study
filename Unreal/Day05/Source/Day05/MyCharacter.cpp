...
void AMyCharacter::Fire(const FInputActionValue& Value)
{
	...
	if (IsValid(AnimInstance))
	{
		...
		FTransform SoketTransformn = GetMesh()->GetSocketTransform(FName("ArrowSocket"));
		FVector SocketLocation = SoketTransformn.GetLocation();
		FRotator SocketRotation = SoketTransformn.GetRotation().Rotator();
